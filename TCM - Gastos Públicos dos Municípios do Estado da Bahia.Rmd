...
if(require(abjutils) == FALSE) { install.packages("abjutils")}
if(require(tidyr) == FALSE) { install.packages("tidyr")}
if(require(janitor) == FALSE) { install.packages("janitor")}
...
executar_tidy_data <- function() {
  ...
  tb_gastos_municipios <- DBI::dbReadTable(conect_bd, "tabela_gastos_municipios") %>%
                          ...
                          purrr::map_dfc(stringi::stri_trans_general, list(id = "latin-ascii")) %>%
                          purrr::map_dfc(stringr::str_to_upper) %>%
...
readr::write_csv(tb_gastos_municipios, file.path("bd_sqlite", "tabela_gastos_municipais_arrumados.csv"))
