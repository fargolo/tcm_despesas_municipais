...
if (teste_html_despesas[8] == "-" | teste_html_despesas[13] == "-") {
   ...
   return(print("### O HTML não está com informações completas. Tentar mais tarde. ###"))
...
executar_tidy_data <- function() {
  ...
  tb_despesas_municipios <- DBI::dbReadTable(conect_bd, "tabela_despesas_municipais") %>%
                          ...
                          #!!! Converter a data para o padrão inglês
                          dplyr::mutate_all(stringr::str_to_upper) %>%
                          #!!! Colocar as últimas 4 colunas em letra minúscula
                          dplyr::mutate_all(stringr::str_trim)
                          #!!! Converter o encodinf para UTF-8
