...
DBI::dbWriteTable(conect_bd, "tabela_gastos_municipais_arrumados", tb_gastos_municipios, overwrite = TRUE)
  
readr::write_delim(tb_gastos_municipios, file.path("bd_sqlite", "tabela_gastos_municipais_arrumados.csv"),
                   delim = ";")
...
#    Verificar se a duplicidade de dados deve ser abordada no Scraping ou na etapa do Parser
