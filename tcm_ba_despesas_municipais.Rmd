...
executar_scraping_num_pags <- function(ano_alvos, cod_municipios_alvos) {
...
criar_tb_dcalendario(ano_alvos)
...
executar_scraping_num_pags(ano, cod_municipios)
