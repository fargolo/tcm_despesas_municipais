...
if (length(scraping_html$result) == 0) {
    ...
    print(paste("### Timeout: estrapolou o tempo", "-", nm_arq_html_pag,
                "- doc:", documento,
                "- primeira tentativa. Mais uma tentativa será realizada ###"))
...
if (length(scraping_html$result) == 0) {
    ...
    tb_request <- tibble::tibble(
     ...
     return(print(paste("### Timeout: estrapolou o tempo", "-", nm_arq_html_pag,
                        "- doc:", documento,
                        " da segunda tentativa - Pulando para o próximo link de despesa  ###")))
...
#!!! Procurar uma solução no pacote dplyr oy tibble para o 'armengue' feito na função 'criar_tb_entidades_alvos_paginas'
#    com a função git2r;
...
#!!! Reconfigurar as colunas na 'tabela_despesas_municipais', para definir os campos que devem ser
#    armazenados como numéricos e como float (ponto flutuante), sem mexer na configuração de data,
#    pois o SQLite não suporta formato de data;
...
#!!! Adequar o código para ceitar conexão com o MySQL, PostgreSQL e MongoDB
#- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
# NA INFRAESTRUTURA
